  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <SuccessModal
        ...
        title="Data Kamu telah berhasil disimpan! ≡ƒÆ╛Γ£¿"
      >
        <p>Semua perubahan telah disimpan dan aman.</p>
        <p>Kamu bisa melanjutkan pekerjaan tanpa khawatir. ≡ƒæì</p>
      </SuccessModal>
      <ConfirmationModal
        isOpen={isDeleteModalOpen}
        onClose={() => setDeleteModalOpen(false)}
        onConfirm={confirmDeleteProduct}
        title="Kamu yakin ingin menghapus baris data ini ≡ƒùæ∩╕Å ?"
        variant="delete"
        confirmText="Hapus"
      >
        <p>Apakah Kamu yakin ingin menghapus baris data ini? ≡ƒùæ∩╕Å Data yang dihapus tidak dapat dikembalikan. Pastikan data yang dipilih benar sebelum melanjutkan. Tekan Hapus untuk mengonfirmasi ≡ƒöÑ atau Batal jika ingin mempertahankan data ini ≡ƒÿè.</p>
      </ConfirmationModal>
    </div>
  );
};
