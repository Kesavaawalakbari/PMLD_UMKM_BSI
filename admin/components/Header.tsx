  ...
  return (
    <>
        ...
        <ConfirmationModal
            ...
            title="Kamu yakin mau keluar dari aplikasi≡ƒºÉ?"
            variant="logout"
            confirmText="Keluar"
        >
            <p>Apakah Kamu yakin ingin keluar dari akun? ≡ƒöÆ Semua perubahan yang belum disimpan mungkin akan hilang.</p>
            <p>Kamu dapat masuk kembali kapan saja untuk melanjutkan. Tekan Keluar untuk melanjutkan ≡ƒÜ¬ atau Batal jika ingin tetap berada di akun Kamu ≡ƒÿè.</p>
        </ConfirmationModal>
    </>
  );
};
