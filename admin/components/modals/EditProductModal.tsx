    ...
    return (
        <>
            ...
            <ConfirmationModal
                ...
                title="Kamu yakin ingin menyimpan perubahan pada produk ini ≡ƒô¥?"
                confirmText="Simpan"
            >
                 <p>
                ...
                <p>
                    Pastikan semua informasi seperti nama produk, harga, dan stok sudah benar sebelum menyimpan ya! Kalau masih ingin meninjau ulang, tekan Batal, tapi kalau sudah yakin dengan perubahanmu tekan Simpan Perubahan untuk memperbarui produk ≡ƒöä
                </p>
            </ConfirmationModal>
        </>
    );
